import{db,$,esc,renderRank,setConnection,serverRemaining,sleep}from'./common-v3.22.js';
import{avatarMarkup}from'./avatars-v3.22.js';
...
async function exportQuestionBank(filename){
  ...
  const header=['# QuizRounds v3.22 — banco completo de perguntas.','# Inclui respostas corretas, pontuação, tempo e metadados.','# Este arquivo pode ser importado novamente em modo ADICIONAR ou SUBSTITUIR.',''].join('\n');

...
export function avatarSheetAsset(key){const a=avatarInfo(key);return`assets/avatars/runtime-r18/${a.key}.png?v=3.60-r18`;}
...
function avatarChoicePreviewMarkup(key){const a=avatarInfo(key);return`<span class="avatar-choice-visual"><img class="avatar-choice-image" src="${a.preview}?v=3.60-r18" alt="" decoding="async" loading="lazy"></span>`;}
